...
NS_LOG_COMPONENT_DEFINE ("RrHybridFfMacScheduler");
...
NS_OBJECT_ENSURE_REGISTERED (RrHybridFfMacScheduler);


class RrHybridSchedulerMemberCschedSapProvider : public FfMacCschedSapProvider
{
public:
  RrHybridSchedulerMemberCschedSapProvider (RrHybridFfMacScheduler* scheduler);
...
private:
  RrHybridSchedulerMemberCschedSapProvider ();
  RrHybridFfMacScheduler* m_scheduler;
};

RrHybridSchedulerMemberCschedSapProvider::RrHybridSchedulerMemberCschedSapProvider ()
{
}

RrHybridSchedulerMemberCschedSapProvider::RrHybridSchedulerMemberCschedSapProvider (RrHybridFfMacScheduler* scheduler) : m_scheduler (scheduler)
{
}


void
RrHybridSchedulerMemberCschedSapProvider::CschedCellConfigReq (const struct CschedCellConfigReqParameters& params)
{
  m_scheduler->DoCschedCellConfigReq (params);
}

void
RrHybridSchedulerMemberCschedSapProvider::CschedUeConfigReq (const struct CschedUeConfigReqParameters& params)
{
...
void
RrHybridSchedulerMemberCschedSapProvider::CschedLcConfigReq (const struct CschedLcConfigReqParameters& params)
{
  m_scheduler->DoCschedLcConfigReq (params);
}

void
RrHybridSchedulerMemberCschedSapProvider::CschedLcReleaseReq (const struct CschedLcReleaseReqParameters& params)
{
  m_scheduler->DoCschedLcReleaseReq (params);
}

void
RrHybridSchedulerMemberCschedSapProvider::CschedUeReleaseReq (const struct CschedUeReleaseReqParameters& params)
{
...
class RrHybridSchedulerMemberSchedSapProvider : public FfMacSchedSapProvider
{
public:
  RrHybridSchedulerMemberSchedSapProvider (RrHybridFfMacScheduler* scheduler);
...
private:
  RrHybridSchedulerMemberSchedSapProvider ();
  RrHybridFfMacScheduler* m_scheduler;
};



RrHybridSchedulerMemberSchedSapProvider::RrHybridSchedulerMemberSchedSapProvider ()
{
}


RrHybridSchedulerMemberSchedSapProvider::RrHybridSchedulerMemberSchedSapProvider (RrHybridFfMacScheduler* scheduler)
  : m_scheduler (scheduler)
{
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlRlcBufferReq (const struct SchedDlRlcBufferReqParameters& params)
{
  m_scheduler->DoSchedDlRlcBufferReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlPagingBufferReq (const struct SchedDlPagingBufferReqParameters& params)
{
  m_scheduler->DoSchedDlPagingBufferReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlMacBufferReq (const struct SchedDlMacBufferReqParameters& params)
{
  m_scheduler->DoSchedDlMacBufferReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlTriggerReq (const struct SchedDlTriggerReqParameters& params)
{
  m_scheduler->DoSchedDlTriggerReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlRachInfoReq (const struct SchedDlRachInfoReqParameters& params)
{
  m_scheduler->DoSchedDlRachInfoReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedDlCqiInfoReq (const struct SchedDlCqiInfoReqParameters& params)
{
  m_scheduler->DoSchedDlCqiInfoReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedUlTriggerReq (const struct SchedUlTriggerReqParameters& params)
{
  m_scheduler->DoSchedUlTriggerReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedUlNoiseInterferenceReq (const struct SchedUlNoiseInterferenceReqParameters& params)
{
  m_scheduler->DoSchedUlNoiseInterferenceReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedUlSrInfoReq (const struct SchedUlSrInfoReqParameters& params)
{
  m_scheduler->DoSchedUlSrInfoReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedUlMacCtrlInfoReq (const struct SchedUlMacCtrlInfoReqParameters& params)
{
  m_scheduler->DoSchedUlMacCtrlInfoReq (params);
}

void
RrHybridSchedulerMemberSchedSapProvider::SchedUlCqiInfoReq (const struct SchedUlCqiInfoReqParameters& params)
{
...
RrHybridFfMacScheduler::RrHybridFfMacScheduler ()
  :   m_cschedSapUser (0),
    m_schedSapUser (0),
    m_nextRntiDl (0),
    m_nextRntiUl (0)
{
  ...
  m_cschedSapProvider = new RrHybridSchedulerMemberCschedSapProvider (this);
  m_schedSapProvider = new RrHybridSchedulerMemberSchedSapProvider (this);
}
...
void
RrHybridFfMacScheduler::DoDispose ()
{
  NS_LOG_FUNCTION (this);
...
TypeId
RrHybridFfMacScheduler::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RrHybridFfMacScheduler")
    .SetParent<FfMacScheduler> ()
    .SetGroupName("Lte")
    .AddConstructor<RrHybridFfMacScheduler> ()
    .AddAttribute ("CqiTimerThreshold",
                   "The number of TTIs a CQI is valid (default 1000 - 1 sec.)",
                   UintegerValue (1000),
                   MakeUintegerAccessor (&RrHybridFfMacScheduler::m_cqiTimersThreshold),
                   MakeUintegerChecker<uint32_t> ())
    .AddAttribute ("HarqEnabled",
                   "Activate/Deactivate the HARQ [by default is active].",
                   BooleanValue (true),
                   MakeBooleanAccessor (&RrHybridFfMacScheduler::m_harqOn),
                   MakeBooleanChecker ())
    .AddAttribute ("UlGrantMcs",
                   "The MCS of the UL grant, must be [0..15] (default 0)",
                   UintegerValue (0),
                   MakeUintegerAccessor (&RrHybridFfMacScheduler::m_ulGrantMcs),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("nSpsUe",
                   "The number of Ue's for SPS scheduling (default 1)",
                   UintegerValue (1),
                   MakeUintegerAccessor (&RrHybridFfMacScheduler::m_nSpsUe),
...
void
RrHybridFfMacScheduler::SetFfMacCschedSapUser (FfMacCschedSapUser* s)
{
  m_cschedSapUser = s;
}

void
RrHybridFfMacScheduler::SetFfMacSchedSapUser (FfMacSchedSapUser* s)
{
  m_schedSapUser = s;
}

FfMacCschedSapProvider*
RrHybridFfMacScheduler::GetFfMacCschedSapProvider ()
{
  return m_cschedSapProvider;
}

FfMacSchedSapProvider*
RrHybridFfMacScheduler::GetFfMacSchedSapProvider ()
{
  return m_schedSapProvider;
}

void
RrHybridFfMacScheduler::SetLteFfrSapProvider (LteFfrSapProvider* s)
{
  m_ffrSapProvider = s;
}

LteFfrSapUser*
RrHybridFfMacScheduler::GetLteFfrSapUser ()
{
  return m_ffrSapUser;
}

void
RrHybridFfMacScheduler::DoCschedCellConfigReq (const struct FfMacCschedSapProvider::CschedCellConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoCschedUeConfigReq (const struct FfMacCschedSapProvider::CschedUeConfigReqParameters& params)
{
...
void
RrHybridFfMacScheduler::DoCschedLcConfigReq (const struct FfMacCschedSapProvider::CschedLcConfigReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoCschedLcReleaseReq (const struct FfMacCschedSapProvider::CschedLcReleaseReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoCschedUeReleaseReq (const struct FfMacCschedSapProvider::CschedUeReleaseReqParameters& params)
{
...
void
RrHybridFfMacScheduler::DoSchedDlRlcBufferReq (const struct FfMacSchedSapProvider::SchedDlRlcBufferReqParameters& params)
{
...
void
RrHybridFfMacScheduler::DoSchedDlPagingBufferReq (const struct FfMacSchedSapProvider::SchedDlPagingBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoSchedDlMacBufferReq (const struct FfMacSchedSapProvider::SchedDlMacBufferReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  NS_FATAL_ERROR ("method not implemented");
  return;
...
int
RrHybridFfMacScheduler::GetRbgSize (int dlbandwidth)
{
  for (int i = 0; i < 4; i++)
    {
...
bool
RrHybridFfMacScheduler::SortRlcBufferReq (FfMacSchedSapProvider::SchedDlRlcBufferReqParameters i,FfMacSchedSapProvider::SchedDlRlcBufferReqParameters j)
{
...
uint8_t
RrHybridFfMacScheduler::HarqProcessAvailability (uint16_t rnti)
{
...
uint8_t
RrHybridFfMacScheduler::UpdateHarqProcessId (uint16_t rnti)
{
  NS_LOG_FUNCTION (this << rnti);
...
void
RrHybridFfMacScheduler::RefreshHarqProcesses ()
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoSchedDlTriggerReq (const struct FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
...
void
RrHybridFfMacScheduler::DoSchedDlRachInfoReq (const struct FfMacSchedSapProvider::SchedDlRachInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoSchedDlCqiInfoReq (const struct FfMacSchedSapProvider::SchedDlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
//Sachin: this 'if' is used in case no flow to schedule. [Not used anymore]
  ...
  if (m_nextRntiUl != 0)
    {
      //ZA: Next device to be scheduled. It should not depend on BSR
      for (it = m_ceBsrRxed.begin (); it != m_ceBsrRxed.end (); it++)
        {
  ...
  do
    {
     ...
     // num++;
      ...
      if(num > m_nSpsUe)
        ...
        if ((itRnti != rntiAllocated.end ())||((*it).second == 0))
        {
           //UE already allocated for UL-HARQ -> skip 
        it++;
         if (it == m_ceBsrRxed.end ())
            {
              // restart from the first
          ...
          if (rbPerFlow < 6)
            {
              ...
              //ZA: is it termination or allocation
              rbPerFlow = 0;
    ...
    /**  if ((it == m_ceBsrRxed.end ()) && (num <= m_nSpsUe))
        {
          // restart from the first
          it = m_ceBsrRxed.begin ();
        }**/
...
void
RrHybridFfMacScheduler::DoSchedUlNoiseInterferenceReq (const struct FfMacSchedSapProvider::SchedUlNoiseInterferenceReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
RrHybridFfMacScheduler::DoSchedUlSrInfoReq (const struct FfMacSchedSapProvider::SchedUlSrInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
  return;
}
...
void
RrHybridFfMacScheduler::DoSchedUlMacCtrlInfoReq (const struct FfMacSchedSapProvider::SchedUlMacCtrlInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::DoSchedUlCqiInfoReq (const struct FfMacSchedSapProvider::SchedUlCqiInfoReqParameters& params)
{
  NS_LOG_FUNCTION (this);
...
void
RrHybridFfMacScheduler::RefreshDlCqiMaps (void)
{
...
void
RrHybridFfMacScheduler::RefreshUlCqiMaps (void)
{
  // refresh UL CQI  Map
...
void
RrHybridFfMacScheduler::UpdateDlRlcBufferInfo (uint16_t rnti, uint8_t lcid, uint16_t size)
{
  NS_LOG_FUNCTION (this);
  std::list<FfMacSchedSapProvider::SchedDlRlcBufferReqParameters>::iterator it;
  for (it = m_rlcBufferReq.begin (); it != m_rlcBufferReq.end (); it++)
...
void
RrHybridFfMacScheduler::UpdateUlRlcBufferInfo (uint16_t rnti, uint16_t size)
{
...
void
RrHybridFfMacScheduler::TransmissionModeConfigurationUpdate (uint16_t rnti, uint8_t txMode)
{
