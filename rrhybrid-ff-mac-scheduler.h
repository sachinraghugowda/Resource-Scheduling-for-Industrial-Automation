...
#ifndef RRHYBRID_FF_MAC_SCHEDULER_H
#define RRHYBRID_FF_MAC_SCHEDULER_H
...
class RrHybridFfMacScheduler : public FfMacScheduler
{
public:
  /**
   * \brief Constructor
   ...
   */
  RrHybridFfMacScheduler ();

  /**
   * Destructor
   */
  virtual ~RrHybridFfMacScheduler ();
  ...
  friend class RrHybridSchedulerMemberCschedSapProvider;
  friend class RrHybridSchedulerMemberSchedSapProvider;
...
#endif /* RRHybrid_FF_MAC_SCHEDULER_H */
